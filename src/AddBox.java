...
public class AddBox {
    ...
    public static Parcel display(){
        ...
        TextField rHouseNmber = new TextField();
        rHouseNmber.setPromptText("Receiver House Number");
        ...
        TextField sHouseNmber = new TextField();
        sHouseNmber.setPromptText("Sender House Number");
        ...
        btnOK.setOnAction(e -> {
            parcel = new Parcel(1, status.getText(), Converter.StringToDouble(cost.getText()), Converter.StringToDouble(weight.getText()), Converter.StringToDouble(length.getText()), Converter.StringToDouble(width.getText()), Converter.StringToDouble(height.getText()), Converter.StringToInt(code.getText()), Converter.StringToInt(carID.getText()), Converter.StringToInt(departmentID.getText()), sName.getText(), rName.getText());
            window.close(); 
        });
        ...
        senderLay2.getChildren().addAll(sStreet, sHouseNmber, sPhone, sEmail);
        ...
        receiverLay2.getChildren().addAll(rStreet, rHouseNmber, rPhone, rEmail);
